...
绑定了EIP的ECS实例所在的VPC已经配置了SNAT功能。详细信息，请参见[创建SNAT条目](/intl.zh-CN/用户指南/SNAT/创建SNAT条目.md)。
...
![](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1734029951/p49564.png)
