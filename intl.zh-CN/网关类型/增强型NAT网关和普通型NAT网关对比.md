...
|---|--------|--------|----|
|同VPC多NAT网关|支持|不支持|[创建NAT网关](/intl.zh-CN/用户指南/NAT网关实例/创建NAT网关.md)|
|NAT网关关联交换机|支持|不支持|
...
|监控指标|22个|4个|[使用云监控来监控NAT网关](/intl.zh-CN/用户指南/使用云监控来监控NAT网关.md)|
|网关流量监控（TOP ECS）|支持|不支持|[t147949.md\#section\_l14\_d8f\_gsa](/intl.zh-CN/用户指南/使用云监控来监控NAT网关.mdsection_l14_d8f_gsa)|
|NAT网关绑定多EIP|支持|支持|[绑定弹性公网IP](/intl.zh-CN/用户指南/NAT网关实例/创建NAT网关实例.md)|
|SNAT功能|支持|支持|[创建SNAT实现访问公网服务](/intl.zh-CN/用户指南/SNAT/创建SNAT实现访问公网服务.md)|
|一个SNAT列表创建多条SNAT条目|支持|支持|[创建SNAT实现访问公网服务](/intl.zh-CN/用户指南/SNAT/创建SNAT实现访问公网服务.md)|
|一个SNAT列表绑定多个EIP|支持|支持|
|DNAT功能|支持|支持|[创建DNAT提供公网服务](/intl.zh-CN/用户指南/DNAT/创建DNAT提供公网服务.md)|
|DNAT支持端口映射|支持|支持|[创建DNAT提供公网服务](/intl.zh-CN/用户指南/DNAT/创建DNAT提供公网服务.md)|
|DNAT支持IP映射|支持|支持|
...
|一个NAT网关支持添加的DNAT条目的数量|100个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|100个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|
|一个NAT网关支持添加的SNAT条目的数量|40个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|40个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|
...
|一个NAT网关支持绑定的EIP的数量|20个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|20个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|
|一个NAT网关支持绑定的按流量计费EIP的数量|10个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|10个（可自助提升配额。具体操作，请参见[管理配额](/intl.zh-CN/用户指南/通用配置/管理配额.md)）|
