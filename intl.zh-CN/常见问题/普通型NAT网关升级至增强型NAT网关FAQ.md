...
|---|--------|--------|----|
|创建和升级是否需要关联交换机|是|否|[创建NA网关实例](/intl.zh-CN/控制台操作指南/创建NA网关实例.md)|
|是否需要交换机分配地址|是|否|
|NAT网关关联交换机|支持|不支持|
...
|网关流量监控（TOP ECS）|支持|不支持|[t147949.md\#section\_m95\_sta\_kek](/intl.zh-CN/控制台操作指南/NAT网关监控与运维.md)|
...
|一个EIP是否同时支持SNAT和DNAT|支持|不支持|[绑定弹性公网IP](/intl.zh-CN/控制台操作指南/创建NA网关实例.md)|
