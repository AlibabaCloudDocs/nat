...
NAT gateways support the DNAT feature. DNAT maps public IP addresses to ECS instances in a VPC. This way, the ECS instances can receive requests from the Internet.
