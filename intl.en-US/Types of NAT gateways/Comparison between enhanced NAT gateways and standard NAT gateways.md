...
|Billing on an hourly basis|Supported|Not supported|[t16029.md\#section\_v5g\_sue\_5bj](/intl.en-US/Pricing/Pay-as-you-go.mdsection_v5g_sue_5bj)|
|Billing on a daily basis|Not supported|Supported|[t16029.md\#](/intl.en-US/Pricing/Pay-as-you-go.md)|
...
|Elastic Compute Service \(ECS\) instances use SNAT to access services that use DNAT to provide Internet-facing services when the same enhanced NAT gateway is used for SNAT and DNAT|Not supported|Supported|[t1997525.md\#]()|
